...
// by: Matthew Fairfax
//
// Note: this version has Windows-specific code gutted out
// so things like Visual Studio resources don't work.
// by: Kaolin Fire
//
...
#include "os.h" // kaolin's attempt at cross-platform sanity
